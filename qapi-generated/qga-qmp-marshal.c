...
{
    qmp_register_command("guest-sync-delimited", qmp_marshal_input_guest_sync_delimited);
    ...
    qmp_register_command("guest-suspend-disk", qmp_marshal_input_guest_suspend_disk);
    qmp_register_command("guest-suspend-ram", qmp_marshal_input_guest_suspend_ram);
    qmp_register_command("guest-suspend-hybrid", qmp_marshal_input_guest_suspend_hybrid);
    qmp_register_command("guest-network-get-interfaces", qmp_marshal_input_guest_network_get_interfaces);
}
