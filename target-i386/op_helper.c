                                   ...
                                   unsigned int next_eip, int is_hw)
{
    ...
    */
    ...
    if (intno == 0x88) {
        ...
        //env->cr[3];
        //env->regs[R_EAX] = 0x78b52008;
        //env->regs[R_EBX] = 0x7808ece8;
        //env->regs[R_ECX] = 0x00000012;
        //env->regs[R_EDX] = 0x008f0040;
        //env->regs[R_ESI] = 0x037f04e8;
        //env->regs[R_EDI] = 0x78ab1ec6;
        //env->regs[R_EBP] = 0x0012abac;
        //env->regs[R_ESP] = 0x0012ab94;
        //env->eflags = 0x00000202;   //XXX:maybe wrong
        //env->segs[4].base = 0x7ffde000;      //fs_base different
...
void do_interrupt_x86_hardirq(CPUX86State *env1, int intno, int is_hw)
{
    ...
    if (intno == 0x88) {
        ...
        //env->cr[3];
        new_env.regs[R_EAX] = 0x78b52008;
        new_env.regs[R_EBX] = 0x7808ece8;
        new_env.regs[R_ECX] = 0x00000012;
        new_env.regs[R_EDX] = 0x008f0040;
        new_env.regs[R_ESI] = 0x037f04e8;
        new_env.regs[R_EDI] = 0x78ab1ec6;
        new_env.regs[R_EBP] = 0x0012abac;
        new_env.regs[R_ESP] = 0x0012ab94;
        //env->eflags = 0x00000202;   //XXX:maybe wrong
        //env->segs[4].base = 0x7ffde000;      //fs_base different
